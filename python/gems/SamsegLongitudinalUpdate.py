...
class SamsegLongitudinalUpdate:
    def __init__(self,
        imageFileNamesList,
        updateFileNamesList,
        atlasDir,
        ...
        self.imageTimePoints = [1,2,3] #TODO: Chaneg this later back
    ...
    def loadProcessedFiles(self):
        ...
        self.sstModel.gmm.means = self.finalState["latentMeans"]
        self.sstModel.gmm.variances = self.finalState["latentVariances"]
        self.sstModel.gmm.mixtureWeights = self.finalState["latentMixtureWeights"]
        self.sstModel.biasField.coefficients = self.finalState["sstBiasFieldCoefficients"]
        self.sstModel.deformation = self.finalState["latentDeformation"]
        self.sstModel.deformationAtlasFileName = self.finalState["latentDeformationAtlasFileName"]
    ...
    def fitModel(self):
        ...
        while True:
            ...
            self.timerFit(f"Fit Latent Deformation {iterationNumber}" )
            self.updateGMMLatentVariables()
            self.timerFit(f"Fit Latent GMM {iterationNumber}")
            iterationNumber += 1
